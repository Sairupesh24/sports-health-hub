-- Migration: Add Profession to Profiles and Update Entitlements
-- This facilitates granular role-based filtering (Physio vs Nutritionist)

-- 1. Add Profession column
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS profession TEXT;

-- 2. Backfill profession based on ams_role
UPDATE public.profiles
SET profession = 'Sports Scientist'
WHERE ams_role = 'coach' AND profession IS NULL;

-- 3. Update complete_session to use profession for fallback
...
BEGIN
    ...
    IF v_resolved_svc_id IS NULL THEN
        ...
        IF v_therapist_prof = 'Sports Scientist' THEN
            ...
            LIMIT 1;
        ELSIF v_therapist_prof = 'Physiotherapist' THEN
            SELECT id INTO v_resolved_svc_id
            FROM   public.services
            WHERE  organization_id = v_session.organization_id
